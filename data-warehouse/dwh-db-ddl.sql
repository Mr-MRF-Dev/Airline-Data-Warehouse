...
(
    ...
    Effective_Start_Date DATE,
    Effective_End_Date DATE,
    -- Passport_Code_Change_Bit BIT, -- 00001
    -- Phone_Number_Change_Bit BIT, -- 00010
    -- Loyalty_Tier_Change_Bit BIT, -- 00100
    -- Is_Active_Change_Bit BIT, -- 01000
    -- Updated_At_Change_Bit BIT, -- 10000
    Update_Bits CHAR(5),
    Is_Current BIT
);
